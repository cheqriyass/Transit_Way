...
<head>
    ...
    <title>Supprimer une ligne</title>
            ...
            <div class="tableaudebord">
                <div class="contact_container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <h2>Supprimer une ligne</h2> <br/><br/>
                ...
                <div class='container'>
                    <div class='row'>
                        ...
                        <form class="form-horizontal" role="form" action="/transit/deleteLigne" method="get">
                            <div class='row'>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        <label for="ligne" class="col-sm-5 control-label">Numero Ligne </label>
                                        <div class="col-sm-7">
